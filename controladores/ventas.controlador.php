...
/*
		 		...
		 		echo utf8_decode("</td>
					<td style='border:1px solid #eee;'>G. ".number_format($item["impuesto"],2)."</td>
					<td style='border:1px solid #eee;'>G. ".number_format($item["neto"],2)."</td>	
					<td style='border:1px solid #eee;'>G. ".number_format($item["total"],2)."</td>
